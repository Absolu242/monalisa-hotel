              ...
              <div className="home__about--main">
                ...
                <div className="home__about--middle">
                  ...
                  <div className="text">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Maiores, recusandae pariatur magni ab et culpa maxime error quo expedita est aspernatur quaerat repudiandae? Est iste dolor commodi at ea sunt! Lorem ipsum dolor sit amet consectetur adipisicing elit. Nulla praesentium assumenda ex harum. Iusto neque, eveniet dignissimos asperiores ex voluptate.</p>

                    <span>
                      <p className="grey">
                        <span className="f-bold black">Ethan Hunt </span>- Director at Monalisa
                      </p>
                    </span>
                  </div>
                </div>
              ...
              <div className="left">
                <div className="left__content">
                  ...
                  <div className="left__content--list">
                    {rooms.map((room, i) => (
                      <div className="left__content--item" key={i} onClick={() => setImage(room.main_img)}>
                        ...
                        <div className="info">
                          ...
                          <p className="grey">
                            ...
                            <span className="black">
                              {" "}
                              <span className="red">${room.price_start}</span>/Night
                            </span>
                          </p>
                        </div>
                      </div>
              ...
              <div className="right">
                <div className="right__content ">
                  {image === "" ? (
                    <div className="info">
                      {" "}
                      <p className="text-center  ">Click on a room to see it's image here</p>
                    </div>
                  ) : (
            ...
            <div className="home__blog--content container">
              ...
              <div className="home__blog--list container">
                <div className="home__blog--item">
                  <div className="img bg" style={{ backgroundImage: `url(${bkg})` }}></div>
                  <div className="info">
                    <p className="date">June ,26 ,2020</p>
                    <h3>Five reasons to stay at the beautiful monalisa Hotel</h3>
              ...
              <div className="right">
                <div className="right__content">
                  ...
                  <div className="right__content--info">
                    ...
                    <p className="address grey">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque, deserunt?</p>
                    <p className="email">
                      <span className="black f-bold">Email : </span> <span className="grey">info@monalisahotel.com</span>
                    </p>
                    <span className="call">
