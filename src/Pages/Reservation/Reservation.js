                  ...
                  <div className='av_room--left'>
                    ...
                    <div className='info-1'>
                      ...
                      <div className='status'>
                        {" "}
                        Status : <span className='green f-bold'>
                          Available
                        </span>{" "}
                      </div>
                      <div className='status'>
                        {" "}
                        Deposit :{" "}
                        <span className='black f-bold'>Not Required</span>{" "}
                      </div>
                      <div className='status'>
                        {" "}
                      ...
                      <div className='status'>
                        {" "}
                        Passenger : <span className='black f-bold'>
                          02
                        </span>{" "}
                      </div>
                    </div>
            ...
            <div className='reservation__booking--content'>
              <div className='bo-dates text-center'>
                <div className='grey'>
                  ...
                  <p>
                    Departure date:{" "}
                    <span className='black'>June,29th,2019</span>
                  </p>{" "}
                </div>
              </div>
                    ...
                    <div className='info-3'>
                      ...
                      <div className='choices'>
                        <div>
                          <div className='grey'>
                            Includes :{" "}
                            <span className='black'>Includes Breakfast</span>
                          </div>
                          <div className='grey'>
                            Deposit :{" "}
                            <span className='black'>Not Required</span>
                          </div>
                        </div>
                        <div>
                          <div className='grey'>
              ...
              <div className='bo-room__pricing'>
                ...
                <span className='total text-center'>
                  <p className=' f-bold'>Total Price</p>{" "}
                  <p className='grey'>(Includes 10% Tax)</p>{" "}
                </span>
